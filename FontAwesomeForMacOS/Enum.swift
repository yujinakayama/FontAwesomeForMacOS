...
public enum FontAwesome: String {
    ...
    case Barcode = "\u{f02a}"
    case Bars = "\u{f0c9}"
    case Battery0 = "\u{f244}"
    case Battery1 = "\u{f243}"
    case Battery2 = "\u{f242}"
    case Battery3 = "\u{f241}"
    case Battery4 = "\u{f240}"
    case BatteryEmpty = "\u{f244}A"
    case BatteryFull = "\u{f240}A"
    case BatteryHalf = "\u{f242}A"
    case BatteryQuarter = "\u{f243}A"
    case BatteryThreeQuarters = "\u{f241}A"
    case Bed = "\u{f236}"
    case Beer = "\u{f0fc}"
    case Behance = "\u{f1b4}"
    ...
    case HourglassEnd = "\u{f253}A"
    case HourglassHalf = "\u{f252}A"
    case HourglassO = "\u{f250}"
    case HourglassStart = "\u{f251}A"
    case Houzz = "\u{f27c}"
    case Html5 = "\u{f13b}"
    case ICursor = "\u{f246}"
    case ILS = "\u{f20b}"
